...
fn wire_entities_set_transform_raw_impl(
    indices: impl Wire2Api<Vec<u32>> + UnwindSafe,
    positions: impl Wire2Api<Vec<f32>> + UnwindSafe,
    origins: impl Wire2Api<Vec<f32>> + UnwindSafe,
    rotations: impl Wire2Api<Vec<f32>> + UnwindSafe,
    scales: impl Wire2Api<Vec<f32>> + UnwindSafe,
) -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
...
fn wire_entity_set_vertices_raw_impl(
    index: impl Wire2Api<GenerationalIndex> + UnwindSafe,
    vertices: impl Wire2Api<Vec<f32>> + UnwindSafe,
) -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
...
fn wire_entity_set_tex_coords_raw_impl(
    index: impl Wire2Api<GenerationalIndex> + UnwindSafe,
    tex_coords: impl Wire2Api<Vec<f32>> + UnwindSafe,
) -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
...
fn wire_entity_set_indices_raw_impl(
    index: impl Wire2Api<GenerationalIndex> + UnwindSafe,
    indices: impl Wire2Api<Vec<u16>> + UnwindSafe,
) -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
...
fn wire_entities_set_priority_raw_impl(
    indices: impl Wire2Api<Vec<u32>> + UnwindSafe,
    priorities: impl Wire2Api<Vec<i32>> + UnwindSafe,
) -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {

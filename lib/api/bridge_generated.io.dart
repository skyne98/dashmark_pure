...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  WireSyncReturn wire_entities_set_transform_raw(
    ffi.Pointer<wire_uint_32_list> indices,
    ffi.Pointer<wire_float_32_list> positions,
    ffi.Pointer<wire_float_32_list> origins,
    ffi.Pointer<wire_float_32_list> rotations,
    ffi.Pointer<wire_float_32_list> scales,
  ) {
  ...
  late final _wire_entities_set_position_rawPtr = _lookup<
          ffi.NativeFunction<
              WireSyncReturn Function(ffi.Pointer<wire_uint_32_list>,
                  ffi.Pointer<wire_float_32_list>)>>(
  ...
  late final _wire_entities_set_scale_rawPtr = _lookup<
      ffi.NativeFunction<
          WireSyncReturn Function(ffi.Pointer<wire_uint_32_list>,
              ffi.Pointer<wire_float_32_list>)>>('wire_entities_set_scale_raw');
  ...
  WireSyncReturn wire_entity_set_vertices_raw(
    ffi.Pointer<wire_GenerationalIndex> index,
    ffi.Pointer<wire_float_32_list> vertices,
  ) {
  ...
  WireSyncReturn wire_entity_set_tex_coords_raw(
    ffi.Pointer<wire_GenerationalIndex> index,
    ffi.Pointer<wire_float_32_list> tex_coords,
  ) {
  ...
  WireSyncReturn wire_entity_set_indices_raw(
    ffi.Pointer<wire_GenerationalIndex> index,
    ffi.Pointer<wire_uint_16_list> indices,
  ) {
  ...
  late final _wire_entity_set_indices_rawPtr = _lookup<
      ffi.NativeFunction<
          WireSyncReturn Function(ffi.Pointer<wire_GenerationalIndex>,
              ffi.Pointer<wire_uint_16_list>)>>('wire_entity_set_indices_raw');
  ...
  WireSyncReturn wire_entities_set_priority_raw(
    ffi.Pointer<wire_uint_32_list> indices,
    ffi.Pointer<wire_int_32_list> priorities,
  ) {
  ...
  late final _wire_entities_set_priority_raw =
      _wire_entities_set_priority_rawPtr.asFunction<
          WireSyncReturn Function(
              ffi.Pointer<wire_uint_32_list>, ffi.Pointer<wire_int_32_list>)>();
